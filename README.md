...
The tool consits of two main modules, Python script for downloading data, and Scala Spark application used for analyzing it.
...
# Scala application
Scala app uses Spark to analyze downloaded data, it will output a csv file containing number of all contracts for each country, and cost of all contracts in all applicable currencies per country.
